 ...
 * Entry: amber-scripts/simple_project/simple.amb
 * Optimization: O1
 * GC: BOEHM
 */
...
char* __amber_rt_double_to_string(void*);
char* __amber_rt_string_to_string(void*);
char* __amber_rt_bool_to_string(void*);
char* __amber_rt_list_to_string(void*);
...
__amber_type_t __amber_type_double = { "num", 1, NULL, 0, __amber_rt_double_to_string };
__amber_type_t __amber_type_string = { "string", 2, NULL, 0, __amber_rt_string_to_string };
__amber_type_t __amber_type_bool = { "bool", 3, NULL, 0, __amber_rt_bool_to_string };
__amber_type_t __amber_type_list = { "list", 4, NULL, 0, __amber_rt_list_to_string };
...
static char* __am_user_to_string(void* val) { return "user"; }
__amber_type_t __am_type_user = { "user", 3599507, NULL, 0, __am_user_to_string };
static inline void* __amber_rt_box___am_user(__am_user v) {
    __am_user_box* p = (__am_user_box*)__amber_rt_alloc(sizeof(__am_user_box));
    p->header.type = &__am_type_user;
    p->value = v;
    return p;
}
static inline __am_user __amber_rt_unbox___am_user(void* p) {
    if (!p) { __am_user v = {0}; return v; }
    return ((__am_user_box*)p)->value;
}
__amber_list_t* __am_users;
__am_user __am_john;
char* __am_change_username(__am_user* __am_u, char* __am_name);

char* __am_change_username(__am_user* __am_u, char* __am_name) {
return (*__am_u).name = __am_name    ;
}
int main(int argc, char** argv) {
    GC_INIT();
__am_users = __amber_rt_create_list(1, __amber_rt_box___am_user(({ __am_user __am_tmp = {0}; __am_tmp.name = "John"; __am_tmp.age = 18.0; __am_tmp; })))    ;
({ __amber_list_t* _l = __am_users; __amber_rt_list_push(_l, ({ __am_user __am_tmp = {0}; __am_tmp.name = "John"; __am_tmp.age = 18.0; __am_tmp; })); _l; })    ;
__amber_rt_println(__am_users)    ;
__am_john = ({ __am_user __am_tmp = {0}; __am_tmp.name = "John"; __am_tmp.age = 18.0; __am_tmp; })    ;
__amber_rt_println(__amber_rt_box_string(__amber_rt_str_concat(__amber_rt_str_concat(__amber_rt_str_concat(__amber_rt_str_concat("Hello ", __am_john.name), " you are "), __amber_rt_to_string(__amber_rt_box_double(__am_john.age))), " years old")))    ;
__am_change_username(&__am_john, "Johny")    ;
__amber_rt_println(__amber_rt_box_string(__amber_rt_str_concat(__amber_rt_str_concat(__amber_rt_str_concat(__amber_rt_str_concat("Hello ", __am_john.name), " you are "), __amber_rt_to_string(__amber_rt_box_double(__am_john.age))), " years old")))    ;
    return 0;
}
